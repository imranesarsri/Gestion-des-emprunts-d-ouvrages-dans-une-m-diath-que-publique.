            ...
            <form action="" method='POST'>
                ...
                <div class='men d-flex'>
                    <div class="w-50 p-3">
                        ...
                        <div>
                            <select name="Status" style='background-color:#020824;color:white;border:none;outline: none ;width:150px;height: 180px;' multiple id="type-select">
                    ...
                    <div class="w-50 p-3">
                        ...
                        <div>
                            <select name="State" style='background-color:#020824;color:white;border:none;outline: none ;width:150px;height: 180px;' multiple id="type-select">
