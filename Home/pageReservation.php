        ...
        <div class='w-50 border border-white border-3 p-5'>
            <form action="" method="POST">
                ...
                <div class="d-flex gap-3">
                    <input class="form-check-input cheked" type="checkbox" value="" id="" >
                ...
                <div class="d-flex gap-3">
                    <input class="form-check-input cheked" type="checkbox" style="width: 1.7em;" value="" id="" >
                ...
                <button type="submit" name="btnReservation" value="<?php echo $row['Item_Code'] ?>" style="background: linear-gradient(222.28deg, #7000FF, rgba(250, 0, 255) 98.17%);" class="w-100 p-3 text-white ">reservation</button>
            </form>
        </div>
    </div>
<?php
