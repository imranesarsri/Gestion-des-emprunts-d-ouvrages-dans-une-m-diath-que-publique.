...
.img_profil  {
    ...
    background: url(../admin/Item_Images/user3.jpg)no-repeat center;
...
<div class="profil">
  ...
  <div class="item_three item">
    ...
    <div class="mt-4 fs-4 text-danger">
      <span class="iconify fs-2" type="button" data-bs-toggle="modal" data-bs-target="#password"  data-icon="material-symbols:lock-outline"  style="color:#020824;cursor: pointer;"></span>
    </div>
    <div class="mt-4 fs-4 text-success">
    ...
    <div class="mt-4 fs-4 text-danger">
      <i class="fa-regular fa-trash-can" style="color:#020824;cursor: pointer;"></i>
    </div>
  </div>  
