        ...
        <nav>
            ...
            <table>
                <form action="" method="POST">
                    ...
                    <div class="d-flex justify-content-between gap-5 text-white mt-4 mb-4">
                        <div>
                            <input required type="radio" name="type" value="Number of pages" id="Number">
                            <label for="Number">Number of pages</label>
                        </div>
                        <div>
                            <input required type="radio" name="type" value="Duration" id="Duration">
            ...
            <?php
                ...
                if(isset($_POST["btnAddCateg"])){
                    $stmt = $db->prepare( "INSERT INTO `category`( `Category_Name` , `Category_Type`) VALUES (:nameCategory , :typeCategory)");

                    
                $stmt->execute([
                    'nameCategory'  => $_POST["addCategory"],
                    'typeCategory'  => $_POST["type"],
                    ]);
                }
            ?>
