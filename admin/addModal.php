        ...
        <div class="modal-content">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <label class="text-start">edition date</label>
                    <input type="date" class="w-100 p-2 mt-4" name="editDate" id="editDate" >
                    <label class="text-start">purchase date</label>
                    <input type="date" class="w-100 p-2 mt-4" name="purchaseDate" id="purchaseDate">
                    <label class="text-start">image caver</label>
                    <input required type="file" class="w-100 p-2 mt-4 border border-dark" name="coverImage" id="">
                ...
                ?>
                    <div class="w-50">
                        <input required name="category" id="<?php echo $row['Category_Name'] ?>" value='<?php echo $row['Category_Code'] ?>' type="radio">
