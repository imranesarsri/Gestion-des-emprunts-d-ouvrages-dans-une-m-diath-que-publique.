    ...
    <header style="height: 70vh;"> 
        <div class="container">
            ...
            <form action="" method='POST'>
                ...
                <div class='men'>
                    <div class="d-flex">
                        <select name="Status" style='background-color:#020824;color:white;border:none;outline: none;width:150px;height: 180px;overflow: hidden;' multiple class=' '>
                        ...
                        <select name="State" style='background-color:#020824;color:white;border:none;outline: none ;width:150px;height: 180px;overflow: hidden;' multiple class=' '>
                        ...
                        <select name="Category" style='background-color:#020824;color:white;border:none;outline: none ;width:150px;height: 180px;overflow: hidden;' multiple class=' '>
                            <?php
                        ...
                        <div class="d-flex">
                            <select name="info" style='background-color:#020824;color:white;border:none;outline: none ;width:150px;height: 180px;overflow: hidden;' multiple class=' '>
