                ...
                <form action="" method="POST">
                    ...
                    <div class="mt-4">
                        <div>
                            ...
                            <input id="Fonctionnaire" type="radio" name="type" <?php if($valueType == "Salarié"){ echo "checked";}?> value="Salarié">
                            <label for="Fonctionnaire">Salarié</label><br>
                        </div>
                        <div class="mt-3">
                            <input id="Employee" type="radio" name="type" <?php if($valueType == "Étudiant"){ echo "checked";}?> value="Étudiant">
                            <label for="Employee">Étudiant</label>
                            <input id="Housewife" type="radio" name="type" <?php if($valueType == "Entrepreneur"){ echo "checked";}?> value="Entrepreneur">
                            <label for="Housewife">Entrepreneur</label>
                        </div>
                    </div>
